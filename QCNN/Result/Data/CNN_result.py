...
print(
    "Resize256(ADAM) result: "
    + str(CNN_resize256_adam.mean())
    + " +/- "
    + str(CNN_resize256_adam.std())
)
...
print("\n")
print(
    "Resize256(nesterov) result: "
    + str(CNN_resize256_nesterov.mean())
    + " +/- "
    + str(CNN_resize256_nesterov.std())
)
print(
    "PCA8(nesterov) result: "
    + str(CNN_pca8_nesterov.mean())
    + " +/- "
    + str(CNN_pca8_nesterov.std())
)
print(
    "AE8(nesterov) result: " + str(CNN_ae8_nesterov.mean()) + " +/- " + str(CNN_ae8_nesterov.std())
)
print(
    "PCA16(nesterov) result: "
    + str(CNN_pca16_nesterov.mean())
    + " +/- "
    + str(CNN_pca16_nesterov.std())
)
print(
    "AE16(nesterov) result: "
    + str(CNN_ae16_nesterov.mean())
    + " +/- "
    + str(CNN_ae16_nesterov.std())
)
